...
train_path = "/kaggle/input/dataset-lab7/yelp_review_polarity_csv/yelp_review_polarity_csv/train.csv"
test_path = "/kaggle/input/dataset-lab7/yelp_review_polarity_csv/yelp_review_polarity_csv/test.csv"
