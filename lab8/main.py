#!/usr/bin/env python3
"""
DeepSpeech2-like training pipeline for LJSpeech (cleaned + English names).

Requirements:
- numpy, pandas, librosa, torch, jiwer, textdistance, pyspellchecker (spellchecker)
- (optional) scikit-learn for train_test_split
"""
...
DATA_DIR = "/kaggle/input/ljspeech-1/LJSpeech-1.1"
NUM_WORKERS = 0
SR = 16000
N_MELS = 128
N_FFT = 512
